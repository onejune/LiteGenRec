#!/usr/bin/env python3
"""
Exp14 V2: Mamba4CTR with Dense+Sparse Features
...
def main():
    print("=" * 60)
    print("Exp14 V2: Mamba4CTR with Dense+Sparse Features")
    print("修复版本: 39维特征")
    print("=" * 60)
    ...
    print("实验结果")
    print("=" * 60)
    print(f"Mamba4CTR V2 AUC: {best_auc:.4f}")
    ...
    torch.save(model.state_dict(), 'mamba4ctr_v2_model.pth')
